...
const trim = (str: string) => String.prototype.trim.call(str);

export interface DuParseEntry {
  name: string;
  size: number;
  md5: string;
  md5s: string;
